...
export type StorageHash =
  StorageHashBase<'e7ca5a90bdbabe45ada78e4cc15c89d44f08a1be008b97b061702da57218fa1c'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly License: {
      ...
      readonly giveawayBatch: CodecTypes['pg/text@1']['output'] | null;
      readonly claimedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly token: CodecTypes['pg/text@1']['output'] | null;
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly License: {
      ...
      readonly giveawayBatch: CodecTypes['pg/text@1']['input'] | null;
      readonly claimedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly token: CodecTypes['pg/text@1']['input'] | null;
    };
  };
};
        ...
        readonly entries: {
          readonly table: {
            readonly license: {
              ...
              primaryKey: { readonly columns: readonly ['jti'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'license_email_idx_46df9cad';
                  readonly prefix: 'license_email_idx';
                  readonly columns: readonly ['email'];
                  readonly unique: false;
                },
                {
                  readonly name: 'license_giveawayBatch_idx_42468186';
                  readonly prefix: 'license_giveawayBatch_idx';
                  readonly columns: readonly ['giveawayBatch'];
                  readonly unique: false;
                },
              ];
          ...
          readonly License: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly giveawayBatch: { readonly column: 'giveawayBatch' };
